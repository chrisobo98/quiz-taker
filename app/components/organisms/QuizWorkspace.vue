...
const { current, mode, examIndex, mastery, submitted, wasCorrect, response, answerInput, currentDisposition, currentAttempts, correctDefinition, selectedDefinition, showHint, sessionTarget, questionPosition, modeTitle, showTools, skipQuestion, markKnown, reconsiderKnown, advanceQuestion, submit, retryQuestion } = useQuizEngineContext()
</script>
