...
<template>
  <div class="app-shell">
    ...
    <main v-else-if="screen === 'quiz' && current" class="quiz-wrap">
      <button class="floating-tools" @click="showTools = true" aria-label="Open chemistry tools"><span>⊞</span><b>Tools</b></button>
      ...
      <section class="tools-modal" role="dialog" aria-modal="true" aria-labelledby="tools-title">
        ...
        <div v-else class="periodic-panel">
          <div class="periodic-toolbar">
            <div><span class="eyebrow">{{ activeQuiz.title }}</span><h3>Periodic table of the elements</h3></div>
...
.periodic-panel{padding:19px 24px 12px}.periodic-toolbar{display:flex;justify-content:space-between;align-items:end;margin-bottom:14px}.periodic-toolbar h3{margin:5px 0 0;font-size:20px}.periodic-toolbar label{display:flex;align-items:center;border:1px solid var(--line);background:white}.periodic-toolbar label span{font:9px 'DM Mono';text-transform:uppercase;padding:0 10px;color:var(--muted)}.periodic-toolbar input{border:0;border-left:1px solid var(--line);outline:0;padding:9px;width:190px;font-size:11px}.periodic-scroll{overflow-x:auto;padding-bottom:8px}.periodic-grid{min-width:1040px;display:grid;grid-template-columns:repeat(18,1fr);grid-template-rows:repeat(7,61px) 12px repeat(2,61px);gap:3px}.element-tile{border:1px solid rgba(22,42,45,.25);padding:3px;background:#eef2ef;display:grid;grid-template-columns:1fr auto;grid-template-rows:auto 1fr auto;text-align:left;cursor:pointer;transition:.12s;min-width:0}.element-tile:hover,.element-tile.selected{outline:2px solid var(--ink);z-index:2;transform:scale(1.08)}.element-tile.dimmed{opacity:.16}.element-tile small{font:7px 'DM Mono'}.element-tile strong{grid-column:1/-1;font-size:17px;line-height:18px;align-self:center}.element-tile span{font-size:6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.element-tile em{font:6px 'DM Mono';font-style:normal;text-align:right}.category-alkali{background:#f5c9bd}.category-alkaline{background:#f5dfa4}.category-transition{background:#d5e5e1}.category-post-transition{background:#dce3c0}.category-metalloid{background:#bfe0cf}.category-nonmetal{background:#c9e8e6}.category-halogen{background:#b9d9ee}.category-noble{background:#d8cef0}.category-lanthanide{background:#f3d2df}.category-actinide{background:#e5c8b3}.element-detail{min-height:62px;margin-top:8px;border:1px solid var(--line);padding:9px 13px;display:flex;align-items:center;gap:14px}.element-detail>strong{font-size:30px}.element-detail h4{margin:0;font-size:14px}.element-detail p{margin:3px 0 0;font:9px 'DM Mono';color:var(--muted)}.element-detail>button{margin-left:auto;border:0;background:none;text-decoration:underline;font-size:10px;cursor:pointer}.periodic-legend{display:flex;flex-wrap:wrap;gap:6px 13px;margin-top:10px}.periodic-legend span{background:none;display:flex;align-items:center;gap:4px;font:7px 'DM Mono';color:var(--muted)}.periodic-legend i{width:9px;height:9px;background:inherit;border:1px solid rgba(22,42,45,.2)}.periodic-legend span.category-alkali i{background:#f5c9bd}.periodic-legend span.category-alkaline i{background:#f5dfa4}.periodic-legend span.category-transition i{background:#d5e5e1}.periodic-legend span.category-post-transition i{background:#dce3c0}.periodic-legend span.category-metalloid i{background:#bfe0cf}.periodic-legend span.category-nonmetal i{background:#c9e8e6}.periodic-legend span.category-halogen i{background:#b9d9ee}.periodic-legend span.category-noble i{background:#d8cef0}.periodic-legend span.category-lanthanide i{background:#f3d2df}.periodic-legend span.category-actinide i{background:#e5c8b3}.periodic-note{font:7px 'DM Mono';color:var(--muted);margin:8px 0 0}
